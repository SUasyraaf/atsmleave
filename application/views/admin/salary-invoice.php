    ...
    <section class="invoice" id="invoice">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          From
          <address>
            <strong>Access Techno Solution Malaysia Sdn. Bhd.</strong><br><br>
            No 12-06 (Level 12) Duplex Office, Plaza Azalea, Persiaran Bandaraya Section 14, 40000 Shah Alam.<br><br>
            Office: +603 767 0048<br>
            Sales Line: +603 5524 5662<br>
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
          To
          <address>
            <strong><?php echo $cnt['staff_name']; ?></strong><br><br>
            <?php echo $cnt['city']; ?><br>
            <?php echo $cnt['state']; ?>, <?php echo $cnt['country']; ?><br><br>
